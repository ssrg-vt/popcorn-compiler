...
public class Runtime
{
  ...
  static String COMPILE_OPT;	// "0" is HOMOGENEOUS, "1" is HETEROGENEOUS
  ...
  static void checkProcess (Process p,
			    String runtime) throws InterruptedException
  {
    if (p.waitFor () == 0)
      {
	if (globalVars.DEBUG)
    ...
    InterruptedException
  {
	...
	if (COMPILE_OPT.equals ("0"))
	  {
	    System.out.println ("Compilation: " + COMPILE_OPT +
				" HOMO-GENEOUS");
	  }
	...
	if (globalVars.DEBUG)
	  System.out.
	    println
	    ("---------------- ^ Link 1: No Alignment, No custom LinkerScript ---");
    ...
    for (int w = 0; w < globalVars.A_rodata.size (); w++)
      {
	writer.println (globalVars.A_rodata.get (w).getName () +
			"\t\taddr:0x" +
			Long.toHexString (globalVars.A_text.get (w).
					  getAddr ()) + "\t\tx86size:0x" +
			Long.toHexString (globalVars.A_text.get (w).
					  getSize_x86_64 ()) +
			"\t\t\taRMsize:0x" +
    ...
    AlignmentLogic.set_symbol_AlignmentN (globalVars.A_text,
					  LinkerIO.x86_64_text_alignment,
					  LinkerIO.aarch64_text_alignment, 0,
					  0, 0, true);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_text_alignment,
					  LinkerIO.aarch64_text_alignment,
					  LinkerIO.x86_textLineOffset,
					  LinkerIO.aarch64_textLineOffset);
    //add initial movement of rodata symbols
    AlignmentLogic.set_symbol_AlignmentN (globalVars.A_rodata,
					  LinkerIO.x86_64_rodata_alignment,
					  LinkerIO.aarch64_rodata_alignment,
					  0, 0, 0, true);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_rodata_alignment,
					  LinkerIO.aarch64_rodata_alignment,
					  LinkerIO.x86_rodataLineOffset,
					  LinkerIO.aarch64_rodataLineOffset);
    //add initial movement of data symbols
    AlignmentLogic.set_symbol_AlignmentN (globalVars.A_data,
					  LinkerIO.x86_64_data_alignment,
					  LinkerIO.aarch64_data_alignment, 0,
					  0, 0, true);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_data_alignment,
					  LinkerIO.aarch64_data_alignment,
					  LinkerIO.x86_dataLineOffset,
					  LinkerIO.aarch64_dataLineOffset);
    //add initial movement of bss symbols
    AlignmentLogic.set_symbol_AlignmentN (globalVars.A_bss,
					  LinkerIO.x86_64_bss_alignment,
					  LinkerIO.aarch64_bss_alignment, 0,
					  0, 0, true);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_bss_alignment,
					  LinkerIO.aarch64_bss_alignment,
					  LinkerIO.x86_bssLineOffset,
					  LinkerIO.aarch64_bssLineOffset);

		/************** TLS */
    //add initial movement of TLS data symbols
    AlignmentLogic.set_symbol_AlignmentN (globalVars.A_data_TLS,
					  LinkerIO.x86_64_tls_data_alignment,
					  LinkerIO.aarch64_tls_data_alignment,
					  0, 0, 0, true);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_tls_data_alignment,
					  LinkerIO.aarch64_tls_data_alignment,
					  LinkerIO.x86_tlsdataLineOffset,
					  LinkerIO.aarch64_tlsdataLineOffset);
    //add initial movement of TLSbss symbols
    AlignmentLogic.set_symbol_AlignmentN (globalVars.A_bss_TLS,
					  LinkerIO.x86_64_tls_bss_alignment,
					  LinkerIO.aarch64_tls_bss_alignment,
					  0, 0, 0, true);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_tls_bss_alignment,
					  LinkerIO.aarch64_tls_bss_alignment,
    ...
    /*
       ...
       utilityARG_list.clear();
       AlignmentLogic.compareAndSet_Alignment(LinkerIO.rodataSymbols, 
		LinkerIO.x86_rodataLineOffset, LinkerIO.aarch64_rodataLineOffset);
       LinkerIO.writeOutLinkerScripts();
    ...
    /*
       ...
       runScript("nmScript.sh",utilityARG_list);
       utilityARG_list.clear();
       AlignmentLogic.compareAndSet_Alignment(LinkerIO.dataSymbols, 
	LinkerIO.x86_dataLineOffset, LinkerIO.aarch64_dataLineOffset);
       LinkerIO.writeOutLinkerScripts();
  ...
  static void gatherANDsort () throws InterruptedException, IOException
  {
    ...
    if (globalVars.DEBUG)
      System.out.
	println
	("-1---------------------- Clean Intersection Complete!------------------");

    if (globalVars.DEBUG)
      System.out.
	println
	("-1---------- ^^ Compile 2: No Alignment, Custom Linker Script Order----");
    //do scout compilation
    if (globalVars.DEBUG)
      System.out.
	println
	("-1--------------------- ^^ ReadInLinkerScripts ------------------------");
    LinkerIO.readInLinkerScripts ();
    if (globalVars.DEBUG)
      System.out.
	println
	("-1--------------------- ^^ ReadInLinkerScripts Complete!---------------");

    //add initial movement of text
    AlignmentLogic.set_symbol_Alignment (globalVars.A_text,
					 LinkerIO.x86_64_text_alignment,
					 LinkerIO.aarch64_text_alignment,
					 false);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_text_alignment,
    ...
    AlignmentLogic.set_symbol_Alignment (globalVars.A_rodata,
					 LinkerIO.x86_64_rodata_alignment,
					 LinkerIO.aarch64_rodata_alignment,
					 false);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_rodata_alignment,
					  ...
					  LinkerIO.aarch64_rodataLineOffset);
    //add initial movement of data symbols
    AlignmentLogic.set_symbol_Alignment (globalVars.A_data,
					 LinkerIO.x86_64_data_alignment,
					 LinkerIO.aarch64_data_alignment,
					 false);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_data_alignment,
					  ...
					  LinkerIO.aarch64_dataLineOffset);
    //add initial movement of bss symbols
    AlignmentLogic.set_symbol_Alignment (globalVars.A_bss,
					 LinkerIO.x86_64_bss_alignment,
					 LinkerIO.aarch64_bss_alignment,
					 false);
    LinkerIO.addAlignmentToLinkerScripts (LinkerIO.x86_64_bss_alignment,
    ...
    if (globalVars.DEBUG)
      System.out.
	println
	("-1---------- ^^ Compile 2: COMPLETE ---------------------------------\n");

    if (globalVars.DEBUG)
      System.out.
	println ("-1--------------------- ^^ Reseting Select Storages");
	 ...
	 * @throws IOException
	 */
  static void cleanTargetDIR (String option) throws InterruptedException,
    IOException
  {
