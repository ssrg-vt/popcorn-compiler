...
public class Runtime {
	...
	AlignmentLogic.set_symbol_AlignmentN(globalVars.A_text,
					     ...
					     0, 0, 0, true);
	LinkerIO.
	    addAlignmentToLinkerScripts(LinkerIO.x86_64_text_alignment,
					LinkerIO.aarch64_text_alignment,
	...
	AlignmentLogic.set_symbol_AlignmentN(globalVars.A_rodata,
					     ...
					     0, 0, 0, true);
	LinkerIO.
	    addAlignmentToLinkerScripts(LinkerIO.x86_64_rodata_alignment,
					LinkerIO.aarch64_rodata_alignment,
	...
	AlignmentLogic.set_symbol_AlignmentN(globalVars.A_data,
					     ...
					     0, 0, 0, true);
	LinkerIO.
	    addAlignmentToLinkerScripts(LinkerIO.x86_64_data_alignment,
					LinkerIO.aarch64_data_alignment,
	...
	AlignmentLogic.set_symbol_AlignmentN(globalVars.A_data_TLS,
					     ...
					     0, 0, 0, true);
	LinkerIO.
	    addAlignmentToLinkerScripts(LinkerIO.x86_64_tls_data_alignment,
					LinkerIO.aarch64_tls_data_alignment,
	...
	AlignmentLogic.set_symbol_AlignmentN(globalVars.A_bss_TLS,
					     ...
					     0, 0, 0, true);
	LinkerIO.
	    addAlignmentToLinkerScripts(LinkerIO.x86_64_tls_bss_alignment,
					LinkerIO.aarch64_tls_bss_alignment,
	...
	//check result
	 ...
	 utilityARG_list.clear();
    } static void copyToolToTargetDIR() throws InterruptedException,
	IOException {
	...
	//check result
	 ...
	 commands.add("cp");
	 commands.add(SOURCE_DIR +
		      "/../scriptsMaster/generateObjs_clang.sh");
	 commands.add(TARGET_DIR + "/");
	if (globalVars.DEBUG)
	     System.out.println("cpyTool: " + commands);
