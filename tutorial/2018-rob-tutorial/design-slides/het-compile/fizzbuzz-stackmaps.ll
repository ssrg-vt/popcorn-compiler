; ModuleID = 'fizzbuzz-migpoints.ll'
...
if.then:                                          ; preds = %for.body
  ...
  call void (i64, i32, ...) @llvm.experimental.stackmap(i64 1, i32 0, i32 %i.024, i32 %max)
  br label %for.inc
...
if.then.6:                                        ; preds = %if.else
  ...
  call void (i64, i32, ...) @llvm.experimental.stackmap(i64 2, i32 0, i32 %i.024, i32 %max)
  br label %for.inc
...
if.then.11:                                       ; preds = %if.else.8
  ...
  call void (i64, i32, ...) @llvm.experimental.stackmap(i64 3, i32 0, i32 %i.024, i32 %max)
  br label %for.inc
