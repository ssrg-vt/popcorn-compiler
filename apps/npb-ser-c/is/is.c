...
/* When this is defined memory will be allocated with malloc rather than bss.
 * With HermitCore when BSS is too larage (as it is the case with is class C),
 * there is some nasty page fault bug */
#define USE_MALLOC
...
#ifdef USE_MALLOC
INT_TYPE *key_array, *key_buff1, *key_buff2, *partial_verify_vals;
