...
static inline void unlock_requeue(volatile int *l, volatile int *r, int w)
{
	...
	{// THIS SYSCALL arguments: futexp, futex_op, nr_wake, nr_move, mutex, val, private
	/* The operation wakes up a maximum of val waiters that are waiting on the futex at uaddr,
	 * this system call wakes zero tasks and requeus one task on the mutex.
	 */             
	}
}
