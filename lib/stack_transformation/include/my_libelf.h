...
extern Elf_Data *my_elf32_xlatetom __P((Elf_Data *__dst, const Elf_Data *__src, unsigned __encode));
extern Elf_Data *my_elf64_xlatetom __P((Elf_Data *__dst, const Elf_Data *__src, unsigned __encode));
extern Elf_Data *my_elf32_xlatetof __P((Elf_Data *__dst, const Elf_Data *__src, unsigned __encode));
extern Elf_Data *my_elf64_xlatetof __P((Elf_Data *__dst, const Elf_Data *__src, unsigned __encode));
#if 0
/*
