...
void parse_map_file(list<string> &basic_blocks) {
...
void parse_counter_file(list<uint64_t> &counters) {
  ifstream fp(counter_fn.c_str(), ifstream::binary | ifstream::ate);
  uint64_t counter;
...
int main(int argc, char **argv) {
  ...
  cout << ios::left << setw(50) << "Basic block:" << setw(12) << "Counter:\n";
  for(; bbit != basic_blocks.end(); bbit++, ctrit++)
    cout << ios::left << setw(50) << *bbit << setw(12) << *ctrit << "\n";
